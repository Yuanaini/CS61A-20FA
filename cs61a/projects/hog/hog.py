...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def average_and_return(*arg):
        resutls = [original_function(*arg) for i in range(trials_count)]
        return sum(resutls) / trials_count
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    score_roll_dice = [
        (make_averaged(roll_dice, trials_count)(i, dice)) for i in range(1, 11)]
    return score_roll_dice.index(max(score_roll_dice)) + 1
    # END PROBLEM 9
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    # Replace this statement
    return extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6) if score < 90 else extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=2)
    # END PROBLEM 12
